...
const Contact = () => {
  <script
    src="https://kit.fontawesome.com/a289aa24c0.js"
  ...
  const sendEmail = (e) => {
    ...
    if (
      !/^[\w-]+(\.[\w-]+)*@([\w-]+\.)+[a-zA-Z]{2,7}$/.test(user_email.value)
    ) {
    ...
    <div className="contact" id="contact">
      ...
      <div className="contact-wrapper">
        <div className="form-container">
          ...
          <p className={isError ? "confirmation error" : "confirmation"}>
            {message}
          </p>
        </div>
        <div class="direct-contact-container">
          <div id="left-align">
            <ul class="contact-list">
              <li class="list-item">
                <i class="fa fa-map-marker fa-2x">
                  <span class="contact-text place">Vancouver, BC</span>
                </i>
              </li>
              <br></br>
              <li class="list-item">
            ...
            <ul class="social-media-list">
              <a href="https://github.com/kavindail">
                {" "}
                <li>
              ...
              <a href="https://github.com/kavindail/ReactWebsite">
                {" "}
                <li>
              ...
              <a href="https://www.linkedin.com/in/kavin-dail/">
                {" "}
                <li>
              ...
              <a href="mailto:kavindail17@gmail.com">
                <li>
